        ...
        <div class="navbar-nav align-items-center">
            ...
            <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-4 me-xl-1" @click="showNotificationToast">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end py-0 mt-3" data-bs-popper="static">
                        <li class="dropdown-menu-header border-bottom py-50">
                            <div class="dropdown-header d-flex align-items-center py-2">
                            <h6 class="mb-0 me-auto">Notification</h6>
                            <div class="d-flex align-items-center h6 mb-0">
                                <span class="badge rounded-pill bg-label-primary fs-xsmall me-2">8 New</span>
                                <a href="javascript:void(0)" class="dropdown-notifications-all p-2" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Mark all as read" data-bs-original-title="Mark all as read"><i class="icon-base ri ri-mail-open-line text-heading"></i></a>
                            </div>
                            </div>
                        </li>
