<template>
  <div class="content-wrapper">
    <div class="container-xxl flex-grow-1">
      <p class="mb-6">Provider decision is recorded separately from internal assessment.</p>
      ...
      <div class="card">
        ...
        >
          <template #toolbar-extra>
            ...
            <NuxtLink to="/inventory/warranty-rma" class="btn btn-outline-secondary">RMA</NuxtLink>
          </template>
        </ListPageTableHeader>
...
definePageMeta({ middleware: ['auth', 'check-permission'], title: 'Warranty Claims' })
