<template>
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1">
            ...
            <div class="row g-6">
                <div class="col-12">
                    <h4 class="mt-6 mb-1">Data Stock Out</h4>
                    <p class="mb-0">Kelola pengeluaran stok dan posting transaksi stock out.</p>
                </div>
                <div class="col-12">
                                        <div class="card">
                        <ListPageTableHeader
                            ...
                            search-placeholder="Cari Stock Out..."
                            ...
                            @update:rows="onStockOutToolbarRows"
...
const onStockOutToolbarRows = (value) => {
...
const handleRowsChange = (value) => {
    ...
    stockOutStore.handleRowsChange();
};
