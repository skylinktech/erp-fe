            ...
            <div class="row g-6">
                ...
                <div class="col-12">
                        ...
                        <ListPageTableHeader
                            ...
                            search-placeholder="Cari Stock..."
                            :export-disabled="loading"
                            :export-items="[
                                { value: 'excel', label: 'Excel' },
                                { value: 'pdf', label: 'PDF' },
                            ]"
                            @update:rows="onStockToolbarRows"
...
const onStockToolbarRows = (value) => {
...
const debouncedStockSearch = useDebounceFn(() => {
    ...
    params.value.first = 0;
    stocksStore.setSearch(globalFilterValue.value);
}, 500);
