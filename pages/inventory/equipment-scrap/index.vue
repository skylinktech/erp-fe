<template>
  <div class="content-wrapper">
    <div class="container-xxl flex-grow-1">
      <p class="mb-6">
        Scrap decision ≠ write-off. Request/Approve: qty unchanged. Execute: WRITE_OFF via InventoryPostingService.
      </p>
...
definePageMeta({ middleware: ['auth', 'check-permission'], title: 'Equipment Scrap' })
