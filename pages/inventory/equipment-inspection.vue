<template>
  <div class="content-wrapper">
    <div class="container-xxl flex-grow-1">
      <p class="mb-6">
        Queue equipment RETURNED / UNDER_INSPECTION. Disposition does not write off stock.
      </p>
      ...
      <div class="card">
        ...
        >
          <template #toolbar-extra>
            <NuxtLink to="/inventory/equipment" class="btn btn-outline-secondary">Equipment</NuxtLink>
            <NuxtLink to="/inventory/warranty-assessment" class="btn btn-outline-secondary">
              Warranty
            </NuxtLink>
          </template>
        </ListPageTableHeader>
...
definePageMeta({ middleware: ['auth', 'check-permission'], title: 'Equipment Inspection' })
