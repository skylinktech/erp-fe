<template>
  <div class="content-wrapper">
    <div class="container-xxl flex-grow-1">
      <p class="mb-6">
        Internal repair — no stock mutation. Complete REPAIRED → UNDER_INSPECTION (Phase 18F QC).
      </p>
...
definePageMeta({ middleware: ['auth', 'check-permission'], title: 'Equipment Repair' })
