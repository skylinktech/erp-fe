<template>
  <div class="content-wrapper">
    <div class="container-xxl flex-grow-1">
      <p class="mb-6">
        Service recovery — installs replacement via SITE_ISSUE. Does not require warranty/RMA.
      </p>
...
definePageMeta({ middleware: ['auth', 'check-permission'], title: 'Equipment Replacement' })
