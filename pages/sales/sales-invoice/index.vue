                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <ListPageTableHeader
                            ...
                            search-placeholder="Cari Sales Invoice..."
                            :export-disabled="loading"
                            @update:rows="onSalesInvoiceToolbarRows"
                            @update:search="(v) => { globalFilterValue = v }"
                            @export="exportData"
                        >
                            <template #add>
                                <button
                                    v-if="userHasRole('superadmin') || userHasPermission('create_sales_invoice')"
                                    type="button"
                                    class="btn btn-primary"
                                    @click="navigateTo('/sales/sales-invoice/form')"
                                >
                                            ...
                                            <div class="d-inline-block">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li v-if="userHasRole('superadmin') || (userHasPermission('edit_sales_invoice') && (slotProps.data.status == 'unpaid' || slotProps.data.status == 'partial'))">
                                                        <a class="dropdown-item" href="javascript:void(0)" @click="navigateTo(`/sales/sales-invoice/form/${slotProps.data.id}`)">
...
const onSalesInvoiceToolbarRows = (value) => {
...
definePageMeta({
  ...
  keywords: 'Sales Invoice, Sales, Sinergi Innovate Pratama',
