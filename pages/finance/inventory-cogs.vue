<template>
  <div class="content-wrapper">
    <div class="container-xxl flex-grow-1">
      ...
      <p class="mb-4 text-muted">Inventory-originated COGS reconciliation (VIEW ONLY).</p>
...
<script setup>
definePageMeta({
  title: "Inventory COGS", middleware: ['auth', 'check-permission'] })
...
async function load(){
  ...
  try {
    ...
    const res=await $apiFetch(`${$api.inventoryCogs()}?${params}`)
