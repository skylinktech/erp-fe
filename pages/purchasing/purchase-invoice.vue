...
const statItems = computed(() => [
  {
    ...
    info: {
      ...
      description: 'Jumlah keseluruhan data Purchase Invoice yang terdaftar dalam sistem berdasarkan statistik API.',
    },
  },
  {
    key: 'unpaid',
    ...
    info: {
      title: 'Unpaid',
      description: 'Jumlah dan nilai dokumen Purchase Invoice yang belum dibayar sama sekali.',
    },
  },
  {
    key: 'partial',
    ...
    info: {
      title: 'Partial',
      description: 'Jumlah dan nilai dokumen Purchase Invoice yang sudah dibayar sebagian.',
    },
  },
  {
    key: 'paid',
    ...
    info: {
      title: 'Paid',
      description: 'Jumlah dan nilai dokumen Purchase Invoice yang sudah lunas dibayar.',
    },
  },
  {
    key: 'outstanding',
    ...
    info: {
      title: 'Outstanding',
      description: 'Total nilai Purchase Invoice yang masih belum lunas, gabungan dari invoice berstatus Unpaid dan Partial.',
    },
  },
])
