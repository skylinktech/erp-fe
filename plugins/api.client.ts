...
export default defineNuxtPlugin(() => {
  ...
  const api = {
    ...
    payrollDashboard     : () => `${apiBase}/payroll/dashboard`,
    payrollReports       : (kind: string) => `${apiBase}/payroll/reports/${kind}`,
    payrollPeriods       : () => `${apiBase}/payroll/periods`,
    payrollRuns          : () => `${apiBase}/payroll/runs`,
    payrollRunStatistics : () => `${apiBase}/payroll/runs/statistics`,
    payrollRunShow       : (id: number | string) => `${apiBase}/payroll/runs/${id}`,
    payrollRunCalculate  : (id: number | string) => `${apiBase}/payroll/runs/${id}/calculate`,
    payrollRunRecalculate: (id: number | string) => `${apiBase}/payroll/runs/${id}/recalculate`,
    payrollRunSubmit     : (id: number | string) => `${apiBase}/payroll/runs/${id}/submit`,
    payrollRunApprove    : (id: number | string) => `${apiBase}/payroll/runs/${id}/approve`,
    payrollRunReject     : (id: number | string) => `${apiBase}/payroll/runs/${id}/reject`,
    payrollRunPost       : (id: number | string) => `${apiBase}/payroll/runs/${id}/post`,
    payrollRunEmployees  : (id: number | string) => `${apiBase}/payroll/runs/${id}/employees`,
    payrollRunEmployee   : (id: number | string, employeeId: number | string) => `${apiBase}/payroll/runs/${id}/employees/${employeeId}`,
    payrollComponents    : () => `${apiBase}/payroll/components`,
    payrollComponent     : (id: number | string) => `${apiBase}/payroll/components/${id}`,
    payrollStructures    : () => `${apiBase}/payroll/structures`,
    payrollStructureShow : (id: number | string) => `${apiBase}/payroll/structures/${id}`,
    payrollStructureComponents: (id: number | string) => `${apiBase}/payroll/structures/${id}/components`,
    payrollProfiles      : () => `${apiBase}/payroll/profiles`,
    payrollCompensations : () => `${apiBase}/payroll/compensations`,
    payrollCompensationShow: (id: number | string) => `${apiBase}/payroll/compensations/${id}`,
    payrollCompensationActivate: (id: number | string) => `${apiBase}/payroll/compensations/${id}/activate`,
    payrollTaxProfiles   : () => `${apiBase}/payroll/tax-profiles`,
    payrollBpjsProfiles  : () => `${apiBase}/payroll/bpjs-profiles`,
    payrollVariableInputs: () => `${apiBase}/payroll/variable-inputs`,
    payrollVariableStatistics: () => `${apiBase}/payroll/variable-inputs/statistics`,
    payrollVariableApprove: (id: number | string) => `${apiBase}/payroll/variable-inputs/${id}/approve`,
    payrollPayslips      : () => `${apiBase}/payroll/payslips`,
    payrollPayslipStatistics: () => `${apiBase}/payroll/payslips/statistics`,
    payrollPaymentBatches: () => `${apiBase}/payroll/payment-batches`,
    payrollPaymentStatistics: () => `${apiBase}/payroll/payment-batches/statistics`,
    payrollPaymentShow   : (id: number | string) => `${apiBase}/payroll/payment-batches/${id}`,
    payrollPaymentProcess: (id: number | string) => `${apiBase}/payroll/payment-batches/${id}/process`,
    payrollPaymentRetry  : (id: number | string) => `${apiBase}/payroll/payment-batches/${id}/retry-failed`,
    payrollPaymentExport : (id: number | string) => `${apiBase}/payroll/payment-batches/${id}/export`,
    payrollMePayslips    : () => `${apiBase}/payroll/me/payslips`,
    payrollMePayslipShow : (id: number | string) => `${apiBase}/payroll/me/payslips/${id}`,
    payrollEmployeePayslips: (pegawaiId: number | string) => `${apiBase}/payroll/employees/${pegawaiId}/payslips`,
    payrollPayslipShow   : (id: number | string) => `${apiBase}/payroll/payslips/${id}`,
    ...
    bankAccountLedger: (id: number | string, qs?: string) =>
      `${apiBase}/accounting/bank-accounts/${id}/ledger${qs ? `?${qs}` : ''}`,
    bankAccountLedgerSummary: (id: number | string) =>
      `${apiBase}/accounting/bank-accounts/${id}/ledger/summary`,
    bankTransfersStore: () => `${apiBase}/accounting/bank-transfers`,
    expensesSettle: (id: number | string) => `${apiBase}/accounting/expenses/${id}/settle`,
    ...
    stockReservations      : () => `${apiBase}/stock-reservations`,
    stockReservationAvailability: () => `${apiBase}/stock-reservations/availability`,
    stockReservationBuffers: () => `${apiBase}/stock-reservations/buffers`,
    stockReservationBufferCreate: () => `${apiBase}/stock-reservations/buffer`,
    stockReservationReserve: () => `${apiBase}/stock-reservations/reserve`,
    stockReservationRelease: (id: number | string) => `${apiBase}/stock-reservations/${id}/release`,
    stockReservationCancel: (id: number | string) => `${apiBase}/stock-reservations/${id}/cancel`,
    equipment              : () => `${apiBase}/equipment`,
    equipmentShow          : (id: number | string) => `${apiBase}/equipment/${id}`,
    equipmentUnbox         : (id: number | string) => `${apiBase}/equipment/${id}/unbox`,
    equipmentVerifyComponentSerials: (id: number | string) =>
      `${apiBase}/equipment/${id}/verify-component-serials`,
    equipmentAssignments   : (id: number | string) => `${apiBase}/equipment/${id}/assignments`,
    equipmentEligibleForAssignment: () => `${apiBase}/equipment/eligible-for-assignment`,
    siteEquipment          : (siteId: number | string) => `${apiBase}/sites/${siteId}/equipment`,
    siteEquipmentHistory   : (siteId: number | string) => `${apiBase}/sites/${siteId}/equipment/history`,
    siteEquipmentAssign    : (siteId: number | string) => `${apiBase}/sites/${siteId}/equipment/assign`,
    equipmentAssignmentRemove: (id: number | string) => `${apiBase}/equipment-assignments/${id}/remove`,
    equipmentAssignmentCancel: (id: number | string) => `${apiBase}/equipment-assignments/${id}/cancel`,
    equipmentAssignmentIssue: (id: number | string) => `${apiBase}/equipment-assignments/${id}/issue`,
    equipmentAssignmentReturn: (id: number | string) => `${apiBase}/equipment-assignments/${id}/return`,

    // Phase 18F — fault / withdrawal / inspection
    equipmentIncidents     : () => `${apiBase}/equipment-incidents`,
    equipmentIncidentShow  : (id: number | string) => `${apiBase}/equipment-incidents/${id}`,
    equipmentIncidentAssess: (id: number | string) => `${apiBase}/equipment-incidents/${id}/assess`,
    equipmentIncidentClose : (id: number | string) => `${apiBase}/equipment-incidents/${id}/close`,
    equipmentWithdrawals   : () => `${apiBase}/equipment-withdrawals`,
    equipmentWithdrawalShow: (id: number | string) => `${apiBase}/equipment-withdrawals/${id}`,
    equipmentWithdrawalApprove: (id: number | string) => `${apiBase}/equipment-withdrawals/${id}/approve`,
    equipmentWithdrawalComplete: (id: number | string) => `${apiBase}/equipment-withdrawals/${id}/complete`,
    equipmentInspections   : () => `${apiBase}/equipment-inspections`,
    equipmentInspectionStart: () => `${apiBase}/equipment-inspections/start`,
    equipmentInspectionComplete: (id: number | string) => `${apiBase}/equipment-inspections/${id}/complete`,
    equipmentFaultTimeline : (id: number | string) => `${apiBase}/equipment/${id}/fault-timeline`,

    // Phase 18G — equipment replacement
    equipmentReplacements  : () => `${apiBase}/equipment-replacements`,
    equipmentReplacementShow: (id: number | string) => `${apiBase}/equipment-replacements/${id}`,
    equipmentReplacementApprove: (id: number | string) => `${apiBase}/equipment-replacements/${id}/approve`,
    equipmentReplacementReject: (id: number | string) => `${apiBase}/equipment-replacements/${id}/reject`,
    equipmentReplacementEligible: (id: number | string) => `${apiBase}/equipment-replacements/${id}/eligible-targets`,
    equipmentReplacementBuffers: (id: number | string) => `${apiBase}/equipment-replacements/${id}/buffer-reservations`,
    equipmentReplacementSelect: (id: number | string) => `${apiBase}/equipment-replacements/${id}/select-target`,
    equipmentReplacementComplete: (id: number | string) => `${apiBase}/equipment-replacements/${id}/complete`,
    equipmentReplacementCancel: (id: number | string) => `${apiBase}/equipment-replacements/${id}/cancel`,
    equipmentReplacementReconcile: (id: number | string) => `${apiBase}/equipment-replacements/${id}/reconcile`,
    equipmentReplacementsFor: (id: number | string) => `${apiBase}/equipment/${id}/replacements`,

    // Phase 18H — warranty assessment / claim / RMA
    warrantyProviders      : () => `${apiBase}/warranty/providers`,
    warrantyPolicies       : () => `${apiBase}/warranty/policies`,
    warrantyExclusions     : () => `${apiBase}/warranty/exclusions`,
    warrantyAssessments    : () => `${apiBase}/warranty-assessments`,
    warrantyAssessmentShow : (id: number | string) => `${apiBase}/warranty-assessments/${id}`,
    warrantyClaims         : () => `${apiBase}/warranty-claims`,
    warrantyClaimShow      : (id: number | string) => `${apiBase}/warranty-claims/${id}`,
    warrantyClaimSubmit    : (id: number | string) => `${apiBase}/warranty-claims/${id}/submit`,
    warrantyClaimDecision  : (id: number | string) => `${apiBase}/warranty-claims/${id}/provider-decision`,
    warrantyRmas           : () => `${apiBase}/warranty-rmas`,
    warrantyRmaShow        : (id: number | string) => `${apiBase}/warranty-rmas/${id}`,
    warrantyRmaShip        : (id: number | string) => `${apiBase}/warranty-rmas/${id}/ship`,
    warrantyRmaCancel      : (id: number | string) => `${apiBase}/warranty-rmas/${id}/cancel`,
    warrantyRmaResolution  : (id: number | string) => `${apiBase}/warranty-rmas/${id}/resolution`,
    warrantyRmaReceiveOriginal: (id: number | string) =>
      `${apiBase}/warranty-rmas/${id}/receive-original`,
    warrantyRmaReceiveReplacement: (id: number | string) =>
      `${apiBase}/warranty-rmas/${id}/receive-replacement`,
    equipmentRepairs       : () => `${apiBase}/equipment-repairs`,
    equipmentRepairShow    : (id: number | string) => `${apiBase}/equipment-repairs/${id}`,
    equipmentRepairComplete: (id: number | string) => `${apiBase}/equipment-repairs/${id}/complete`,
    equipmentScraps        : () => `${apiBase}/equipment-scraps`,
    equipmentScrapShow     : (id: number | string) => `${apiBase}/equipment-scraps/${id}`,
    equipmentScrapApprove  : (id: number | string) => `${apiBase}/equipment-scraps/${id}/approve`,
    equipmentScrapExecute  : (id: number | string) => `${apiBase}/equipment-scraps/${id}/execute`,
    equipmentWarranty      : (id: number | string) => `${apiBase}/equipment/${id}/warranty`,

    stockInSerials         : (id: number | string, detailId: number | string) =>
      `${apiBase}/stock-in/${id}/details/${detailId}/serials`,
